...
df = pd.read_csv("licfile.csv", header=None, names=[
    'LICTYPE',
    'LICNUMBER',
    'BIZCOUNTY',
    'BIZNAME',
    ...
    'TELEPHONE',
    'LICSUBTYPE',
    'CEFLAG'], dtype={"EXPIRATION": str, "LICNUMBER": str, "MAILCOUNTYCODE": str, "MAILZIP": str, "TELEPHONE": str})
...
df.LICTYPE.value_counts().sort_values(ascending=False).head(10)
...
df.LICTYPE.value_counts().sort_values(ascending=False).tail(10)
...
electricians = df[df['LICTYPE'].str.contains("Electrician").fillna(False)]
electricians
...
electricians.LICTYPE.value_counts().sort_values().plot(kind='barh')
